    ...
    <div className="container-content py-12">
      ...
      >
        ...
        <motion.div 
          ...
          variants={itemVariants}
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Co to jest Pepper Deals?</h2>
        ...
        <motion.div 
          ...
          variants={itemVariants}
        >
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Jak korzystać z aplikacji?</h2>
